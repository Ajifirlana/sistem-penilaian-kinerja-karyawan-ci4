            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="at.php">Anggota Tim</a>
                        <a class="collapse-item" href="kt.php">Ketua Tim</a>
                        <a class="collapse-item" href="pt.php">Pengendali Teknis</a>
                        <a class="collapse-item" href="pj.php">Penanggung Jawab</a>
                    </div>
                </div>
            </li>
