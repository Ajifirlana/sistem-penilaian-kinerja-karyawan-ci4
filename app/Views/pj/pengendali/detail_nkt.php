...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            <h3 class="px-2 mb-0 text-gray-800">Detail NKT Pengendali Teknis</h3>
            <div class="row">
                <div class="card-body">
                    <table style="text-align: center;" id="example2" class="table table-bordered table-hover">
                        <th>
                            Nama Ketua Pengendali Teknis : <?php echo $nkt['nama_pt']; ?>
                        </th>
                    ...
                    <div class="px-2">
                        <a style="margin-right: 10px;" href="/pj/pengendali/realisasi_nkt/<?php echo $nkt['id_nkt_pt'] ?>" class="btn btn-danger">
