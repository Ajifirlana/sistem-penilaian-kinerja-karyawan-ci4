                    ...
                    <div class="col-md-4-px-2">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Masukan Nomor Surat Dinas" name="no_surat_dinas" value="<?php echo $pj['no_surat_dinas_pj'] ?>">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Ubah Email</label>
                                <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Masukan Email Baru" name="email" value="<?php echo $pj['email_pj'] ?>">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Ubah Password</label>
                                <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Masukan Password Baru" name="password" value="<?php echo $pj['password_pj'] ?>">
                            </div>
