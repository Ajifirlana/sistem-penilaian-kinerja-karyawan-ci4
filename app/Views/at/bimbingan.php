...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            <h3 class="px-2 mb-0 text-gray-800">Data Bimbingan </h3>

            <!-- Page Heading -->
            <div class="row">
                <div class="card-body">
                    <a href="/at/create_bimbingan" class="btn btn-primary mb-3">Tambahkan Bimbingan</a>
                    <table id="example2" class="table table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <th>
                                <a href="/at/detail_bimbingan/<?= $bimbingan['idBimbingan'] ?>" class="btn btn-primary mb-3">Detail</a>
                                <a href="/at/bimbingan/delete/<?= $bimbingan['idBimbingan'] ?>" class="btn btn-danger mb-3">Hapus</a>
                            </th>
