    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            if ($nkp['status'] == 'Pending') { ?>
                <div class="alert alert-danger mt-3" role="alert">NKP belum di realisasi dan di review!</div>
            <?php } else if ($nkp['status'] == 'Proses') { ?>
                <div class="alert alert-warning mt-3" role="alert">NKP telah di realisasi tetapi belum di review!</div>
            <?php } else { ?>
                <div class="alert alert-success mt-3" role="alert">NKP sudah di realisasi dan di review!</div>
            <?php
            }
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                         ...
                         <?php if($soal['nilai'] >= $soal['melebihi']){ ?>
                            <th><input type="radio" name="nilai<?= $urut++?>" value="" checked></th><th><input type="radio" name="nilai<?= $urut++?>" value=""></th><th><input type="radio" name="nilai<?= $urut++?>" value=""></th><th><input type="radio" name="nilai<?= $urut++?>" value=""></th>
                        <?php }else{?>
                        <th><input type="radio" name="nilai<?= $urut++?>" value="" ></th><th><input type="radio" name="nilai<?= $urut++?>" value="" ></th>
                        <th><input type="radio" name="nilai<?= $urut++?>" value=""></th><th><input type="radio" name="nilai<?= $urut++?>" value=""></th>
                        <?php }?>
                           <!-- 
