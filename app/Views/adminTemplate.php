        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="/admin/at">Anggota Tim</a>
                        <a class="collapse-item" href="/admin/kt">Ketua Tim</a>
                        <a class="collapse-item" href="/admin/pt">Pengendali Teknis</a>
                        <a class="collapse-item" href="/admin/pj">Penanggung Jawab</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="/admin/nkp">NKP</a>
                        <a class="collapse-item" href="/admin/nkt">NKT</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
