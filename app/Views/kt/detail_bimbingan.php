    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            if ($bimbingan['status'] == 'Selesai') { ?>
                <div class="alert alert-success mt-3" role="alert">Bimbingan telah di tanggapi!</div>
            <?php } else { ?>
                <div class="alert alert-danger mt-3" role="alert">Bimbingan belum di tanggapi!</div>
            <?php
            }
