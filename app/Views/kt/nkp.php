...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="card-body">
                    <a href="/kt/create_nkp" class="btn btn-primary mb-3">Tambah NKP</a>
                        ...
                        <tbody>
                            <?php foreach ($nkpKT as $no => $nkpKT) : ?>
                                <tr>
                                    ...
                                    <th>
                                        <a href="/kt/detail_nkp/<?= $nkpKT['id_nkp_kt'] ?>" class="btn btn-primary mb-3">Detail</a>
                                        <a href="/kt/nkp/delete/<?= $nkpKT['id_nkp_kt'] ?>" class="btn btn-danger mb-3">Hapus</a>
                                    </th>
