...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            <h3 class="px-2 mb-0 text-gray-800">Data Bimbingan Anggota Tim </h3>
                    ...
                    <table id="example2" class="table table-bordered table-hover">
                        ...
                        <?php foreach ($bimbingan as $no => $bimbingan) : ?>
                            <tr>
                                ...
                                <td><?php echo $bimbingan['nip']; ?></td>
                                <td><?php echo $bimbingan['status']; ?></td>

                                <th>
                                    <a style="width: 100px;" href="/kt/anggota/do_tanggapan/<?php echo $bimbingan['idBimbingan']; ?>" class="btn btn-primary">
