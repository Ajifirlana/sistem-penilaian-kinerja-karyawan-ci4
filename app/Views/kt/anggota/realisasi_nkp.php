...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            <h3 class="px-2 mb-0 text-gray-800">Realisasi Penilaian Kompetensi Perilaku</h3>
            <div class="row">
                <form action="/kt/saveNKP/<?= $nkp['id_nkp_at'] ?>" method="POST" enctype="multipart/form-data">
                    <div class="card-body">
