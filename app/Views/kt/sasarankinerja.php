...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            <h3 class="px-2 mb-0 text-gray-800">Data Sasaran Kinerja</h3>

            <!-- Page Heading -->
            <div class="row">
                <div class="card-body">
                    <a href="/kt/create_sasaran" class="btn btn-primary mb-3">Tambah Sasaran Kinerja</a>
                    <table id="example2" class="table table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="/kt/detail_sasaran/<?php echo $sasaranKT['id_kinerja_kt']; ?>" class="btn btn-primary mb-3">Detail</a>
                                <a href="/kt/sasaran/delete/<?php echo $sasaranKT['id_kinerja_kt']; ?>" class="btn btn-danger mb-3">Hapus</a>
                            </td>
