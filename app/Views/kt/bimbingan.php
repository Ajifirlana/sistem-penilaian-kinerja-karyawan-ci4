...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="card-body">
                    <a href="/kt/create_bimbingan" class="btn btn-primary mb-3">Tambahkan Bimbingan</a>
                    <table id="example2" class="table table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <th>
                                <a href="/kt/detail_bimbingan/<?= $bimbingan['idBimbingan'] ?>" class="btn btn-primary mb-3">Detail</a>
                                <a href="/kt/bimbingan/delete/<?= $bimbingan['idBimbingan'] ?>" class="btn btn-danger mb-3">Hapus</a>
                            </th>
