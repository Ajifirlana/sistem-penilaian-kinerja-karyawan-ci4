...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            <a style="float: right;" href="/pt/edit_nkt/<?= $nkt['id_nkt_pt'] ?>" class="btn btn-primary">Edit NKT</a>
            <h3 class="px-2 mb-0 text-gray-800">Detail NKT</h3>

            <?php
            if ($nkt['status'] == 'Pending') { ?>
                <div class="alert alert-danger mt-3" role="alert">NKT belum di realisasi!</div>
            <?php } else { ?>
                <div class="alert alert-success mt-3" role="alert">NKT telah di realisasi!</div>
            <?php
            }
