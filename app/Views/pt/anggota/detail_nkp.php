...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            <h3 class="px-2 mb-0 text-gray-800">Detail NKP Anggota Tim</h3>
            <div class="row">
                <div class="card-body">
                    <table style="text-align: center;" id="example2" class="table table-bordered table-hover">
                        <th>
                            Nama Anggota Tim : <?php echo $nkp['nama_at']; ?>
                        </th>
                    ...
                    <div class="px-2">
                        <a style="margin-right: 10px;" href="/pt/anggota/do_review_nkp/<?php echo $nkp['id_nkp_at']; ?>" class="btn btn-danger">
