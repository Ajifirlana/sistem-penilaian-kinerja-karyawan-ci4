...
<?= $this-> section('contentAdmin')?>
                ...
                <div class="container-fluid">
                    <h3 class="px-2 mb-0 text-gray-800">Menambahkan Data Ketua Tim</h3>

                    <div class="row">
                        <div class="col-md-4-px-2">
                            <form action="/admin/saveKT" method="POST" enctype="multipart/form-data">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <!-- <input type="select" class="form-control" placeholder="Masukan Nama Penanggung Jawab" name="pj" value=""> -->
                                    </div>
